			...
			<div class="row-fluid">
				...
				<?php if ($this->countModules('position-7')) : ?>
					<div id="aside" class="span3">
						...
						<div class="moi"><jdoc:include type="modules" name="moi"/></div>
						<!-- End Right Sidebar -->
					</div>
				<?php endif; ?>
			</div>
...
hot_s.src = 'http://js.hotlog.ru/dcounter/2462013.js';
hot_d = document.getElementById('hotlog_dyn');
hot_d.appendChild(hot_s);
</script>
<noscript>
<a href="http://click.hotlog.ru/?2462013" target="_blank">
<img src="http://hit6.hotlog.ru/cgi-bin/hotlog/count?s=2462013&im=307" border="0" 
