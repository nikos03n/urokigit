						...
						<div class="control-group">
							...
							<div class="controls">
								<fieldset id="enable_div" class="radio btn-group">
									<input type="radio" id="enable_div0" name="enable_div" value="0" <?php echo !$params->div_enable ? 'checked="checked"' : ''; ?>
										onclick="toggleDivs();" onchange="toggleDivs();" />
									<label for="enable_div0"><?php echo JText::_('JNO'); ?></label>
									<input type="radio" id="enable_div1" name="enable_div" value="1" <?php echo $params->div_enable ? 'checked="checked"' : ''; ?>
										onclick="toggleDivs();" onchange="toggleDivs();" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="text_area" name="div_width" id="div_width"
										value="<?php echo $params->div_width; ?>" size="4" style="width:50px;text-align: right;" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="text_area" name="div_height" id="div_height"
										value="<?php echo $params->div_height; ?>" size="4" style="width:50px;text-align: right;" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<fieldset id="div_float" class="radio btn-group">
										<input type="radio" id="div_float0" name="div_float" value="0" <?php echo !$params->div_float ? 'checked="checked"' : ''; ?> />
										<label for="div_float0"><?php echo JText::_('JNONE'); ?></label>
										<input type="radio" id="div_float1" name="div_float" value="left" <?php echo $params->div_float == 'left' ? 'checked="checked"' : ''; ?> />
										<label for="div_float1"><?php echo JText::_('JGLOBAL_LEFT'); ?></label>
										<input type="radio" id="div_float2" name="div_float" value="right" <?php echo $params->div_float == 'right' ? 'checked="checked"' : ''; ?> />
